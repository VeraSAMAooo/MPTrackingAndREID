...
def main():
    ...
    if not os.path.exists('output'):
        os.makedirs('output')
    out_file = 'E:\\PedestrianTracking\\codes\\keras-yolov3-KF-objectTracking-master\\videos\\003.avi'
    ...
    with open(out_file, 'w') as f_out:
        ...
        for frame in range(0, frames):  #frame numbers begin at 0!
            ...
            total_frames +=1
            fn = 'E:\\PedestrianTracking\\codes\\keras-yolov3-KF-objectTracking-master\\image\\%d.jpg' % (frame )  # video frames are extracted to 'test/Pictures%d.jpg' with ffmpeg
            img = io.imread(fn)
            if (display):
